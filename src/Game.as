   ...
   public class Game extends MovieClip
   {
      ...
      public function start(stage:Stage) : void
      {
		 try
         {
			 ...
			 this.osgi = OSGi.init(false, _stage, this, "37.144.176.209", [54], "37.144.176.209", 54, "resources/", new Logger(), SharedObject.getLocal("game"), "RU", Object);
			 this.main = new Main();
	  ...
	  public function onContext3DCreate(e:Event = null):void {
			try{
				 ...
				 //Main.systemUILayer.addChild(new TheMiner());
				 ...
				 _stage.addEventListener(Event.FULLSCREEN,sd);
			}catch (e:Error)
			{
			}
		}
