		 ...
		 if (message != null)
		 {
			 ...
			 for(var i:int = 0; i < this.sharpLinks.length; i++)
			 {
				try{
					...
					alert.text = "Прызышла ашыбка: chat,replaceSharpLinks,488";
				}
				try{
					result = text.search(currentPattern);
				}catch (e:Error){
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: chat,replaceSharpLinks,494";
				}
				if(result > -1)
				{
					try{
						...
						var alert:AlertBugWindow = new AlertBugWindow();
						alert.text = "Прызышла ашыбка: chat,replaceSharpLinks,502";
						if (text == null)
						{
							var alert:AlertBugWindow = new AlertBugWindow();
							alert.text = "Прастите, снова прызышла ашыбка виноват text";
						}
						if (currentPattern == null)
						{
							var alert:AlertBugWindow = new AlertBugWindow();
							alert.text = "Прастите, снова прызышла ашыбка виноват currentPattern";
						}
						if (this.sharpLinks[i][2] == null)
						{
							var alert:AlertBugWindow = new AlertBugWindow();
							alert.text = "Прастите, снова прызышла ашыбка виноват this.sharpLinks[i][2]";
						}
						if (this.sharpLinks[i][1] == null)
						{
							var alert:AlertBugWindow = new AlertBugWindow();
							alert.text = "Прастите, снова прызышла ашыбка виноват this.sharpLinks[i][1]";
						}
					}
					try{
						this.htmlFlag = true;
						...
						var alert:AlertBugWindow = new AlertBugWindow();
						alert.text = "Прызышла ашыбка: chat,replaceSharpLinks,528";
					}
				}
			 }
		 }
