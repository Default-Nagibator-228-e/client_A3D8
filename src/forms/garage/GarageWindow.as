package forms.garage
{
   ...
   public class GarageWindow extends Sprite
   {
      ...
      public var storeItemSelected:Boolean = false;
      ...
      public function addItemToWarehouse(itemId:String, itemParams:ItemParams, itemInfo:ItemInfo) : void
      {
		 if (itemId == null)
		 {
			...
			alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,314,itemId";
		 }
		 if (itemParams == null)
		 {
			return;
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,314,itemParams";
		 }
		 if (this.itemsInWarehouse == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,314,this.itemsInWarehouse";
		 }
		 if (this.warehouseList == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,314,this.warehouseList";
		 }
		 ...
		 if (itemInfo != null)
		 {
			 if (itemParams.itemType.value == 5)
			 {
				try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,339";
				}
			 }else{
				 try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,346";
				}
			 }
		 }else{
			 ...
			 if (itemParams.itemType.value == 5)
			 {
				 try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,358";
				}
			 }else{
				 try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: garagewindow,addItemToWarehouse,365";
				}
			 }
		 }
      }
