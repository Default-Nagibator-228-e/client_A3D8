package alternativa.osgid.service.mainContainer
{
   ...
   public class MainContainerService implements IMainContainerService, IFocusListener
   {
	  ...
	  private var _warningLayer:DisplayObjectContainer;
	  ...
	  public function get warningLayer() : DisplayObjectContainer
      {
