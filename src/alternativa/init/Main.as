package alternativa.init
{
   ...
   import alternativa.osgid.service.loader.LoadingProgress;
   ...
   import alternativa.protocold.Protocol;
   import alternativa.protocold.codec.ClassCodec;
   import alternativa.protocold.codec.ControlRootCodec;
   import alternativa.protocold.codec.ResourceCodec;
   import alternativa.protocold.codec.SpaceRootCodec;
   import alternativa.protocold.factory.CodecFactory;
   ...
   public class Main implements IBundleActivator
   {
	  ...
	  public static var warningLayer:DisplayObjectContainer;
      ...
      public function start(_osgi:OSGi) : void
      {
		 ...
		 warningLayer = IMainContainerService(osgi.getService(IMainContainerService)).warningLayer;
