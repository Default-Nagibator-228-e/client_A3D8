package alternativa.proplib.objects
{
   ...
   public class PropMesh extends PropObject
   {
      ...
      private function processObjects(modelData:ByteArray, objectName:String) : Mesh
      {
		 ...
		 for each(var obt:* in parser.objects)
		 {
			if (obt is Mesh)
			{
				...
				object.scaleY = 1000;
				object.scaleZ = 1000;
				object.geometry.upload(Game.context);
				setMaterials(object);
	  ...
	  private function createStandardMaterial(materialTextures:Object):VertexLightTextureMaterial {
		...
		var material:VertexLightTextureMaterial = new VertexLightTextureMaterial(materialTextures["diffuse"]);
