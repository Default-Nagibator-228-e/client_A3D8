package alternativa.tanks.models.tank.explosion
{
   ...
   public class TankExplosionModel extends TankExplosionModelBase implements ITankExplosionModelBase, IObjectLoadListener, ITankExplosionModel
   {
      ...
      public function createExplosionEffects(clientObject:ClientObject, tankData:TankData) : void
      {
         ...
         var dx:Number = hullMesh.boundBox.maxX - hullMesh.boundBox.minX;
         var dy:Number = hullMesh.boundBox.maxY - hullMesh.boundBox.minY;
         var dz:Number = hullMesh.boundBox.maxZ - hullMesh.boundBox.minZ;
         ...
         explosion.init(explosionSize,explosionSize,animaton,Math.random() * 2 * Math.PI,pos,0.5,0.5,0,500,1000,15);
         ...
         for(var i:int = 0; i < 3; i++)
         {
            ...
            smokeEffect.init(smokeSize,smokeSize,animationSmoke,Math.random() * 2 * Math.PI,positionProvider,0.5,0.5,0,500,1000,15,false);
