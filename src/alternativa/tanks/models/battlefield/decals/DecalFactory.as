package alternativa.tanks.models.battlefield.decals
{
   ...
   public class DecalFactory
   {
      ...
      public function createDecal(param1:Vector3, param2:Vector3, param3:Number, param4:TextureMaterial, param6:RotationState) : Decal
      {
         ...
         return new Decal();//param5.createDecal(position3D,normal3D,param3,_loc9_,ANGLE_LIMIT,300,param4);
      }
