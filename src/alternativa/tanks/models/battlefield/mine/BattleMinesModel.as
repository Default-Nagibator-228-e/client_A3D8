package alternativa.tanks.models.battlefield.mine
{
   ...
   public class BattleMinesModel extends BattleMinesModelBase implements IBattleMinesModelBase, IObjectLoadListener, IBattlefieldPlugin, IDumper
   {
      ...
      private var mainExplosionSequence:Vector.<TextureMaterial>;
      
      private var mainExplosionFrameSize:FrameSize;
      
      private var idleExplosionSequence:Vector.<TextureMaterial>;
      ...
      public function objectLoaded(clientObject:ClientObject) : void
      {
         ...
         this.mainExplosionSequence = this.getExplosionMaterialSequence(initParams.mainExplosionTextureId,MAIN_EXPLOSION_FRAME_WIDTH);
         this.idleExplosionSequence = this.getExplosionMaterialSequence(initParams.idleExplosionTextureId,IDLE_EXPLOSION_FRAME_WIDTH);
      ...
      public function removeMines(clientObject:ClientObject, ownerId:String) : void
      {
         ...
         while(mine != null)
         {
            currMine = mine;
            mine = mine.next;
            this.addExplosionEffect(currMine.position,this.idleExplosionSequence,this.idleExplosionFrameSize,idleExplosionScale.value,idleExplosionFPS.value,0.5,0.9);
      ...
      public function explodeMine(clientObject:ClientObject, id:String, userId:String) : void
      {
         ...
         this.addExplosionEffect(mine.position,this.mainExplosionSequence,this.mainExplosionFrameSize,mainExplosionScale.value,mainExplosionFPS.value,0.5,0.772);
      ...
      private function addExplosionEffect(position:Vector3, materials:Vector.<TextureMaterial>, frameSize:FrameSize, scale:Number, fps:Number, originX:Number, originY:Number) : void
      {
      ...
      {
         this.referenceMesh = resourse.clone() as Mesh;
      }
      ...
      private function getExplosionMaterialSequence(resourceId:String, frameWidth:int) : Vector.<TextureMaterial>
      {
         ...
         return GraphicsUtils.getTextureAnimation(null,texture,frameWidth,texture.height).material;
      }
