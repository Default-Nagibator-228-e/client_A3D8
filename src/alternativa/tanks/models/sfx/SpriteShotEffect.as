package alternativa.tanks.models.sfx
{
   ...
   public class SpriteShotEffect extends PooledObject implements IGraphicEffect
   {
      ...
      public function init(material:Material, localMuzzlePosition:Vector3, turret:Object3D, localOffset:Number, size:Number, brightTime:int, fadeTime:int,param12:int=500,param13:int=1000) : void
      {
		 //try{
