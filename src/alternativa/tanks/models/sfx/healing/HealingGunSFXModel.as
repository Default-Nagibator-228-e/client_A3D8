package alternativa.tanks.models.sfx.healing
{
   ...
   public class HealingGunSFXModel extends HealingSFXModelBase implements IHealingSFXModelBase, IHealingSFXModel
   {
      ...
      private function createShaftMaterials(source:BitmapData) : Vector.<TextureMaterial>
      {
         var frameWidth:int = 100;
         return GraphicsUtils.getTextureAnimation(null, source, 100, 100).material;//materialRegistry.materialSequenceRegistry.getSequence(MaterialType.EFFECT,source,frameWidth,MIPMAP_RESOLUTION,false,true).materials;
      }
