package alternativa.tanks.models.sfx.shoot.railgun
{
   ...
   public class RailgunSFXModel extends RailgunShootSFXModelBase implements IRailgunShootSFXModelBase, IRailgunSFXModel, IObjectLoadListener
   {
      ...
      private var trailMaterial:TextureMaterial;
	  
	  private var trailMaterial1:TextureMaterial;
      
      private var shotSound:Sound;
      
      private var chargeMaterials:Vector.<TextureMaterial>;
      ...
      public function initObject(clientObject:ClientObject, chargingPart1:String, chargingPart2:String, chargingPart3:String, railImageId:String, shotId:String) : void
      {
         ...
         if(this.numLoadedObjects == 1)
         {
            ...
            this.trailMaterial = createMat(ResourceUtil.getResource(ResourceType.IMAGE,railImageId).bitmapData);//new TanksTextureMaterial(ResourceUtil.getResource(ResourceType.IMAGE,railImageId).bitmapData,true,true,MIPMAP_RESOLUTION,MIPMAP_RESOLUTION);
			this.trailMaterial1 = createMat(ResourceUtil.getResource(ResourceType.IMAGE,shotId).bitmapData);//new TanksTextureMaterial(ResourceUtil.getResource(ResourceType.IMAGE,shotId).bitmapData,true,true,MIPMAP_RESOLUTION,MIPMAP_RESOLUTION);
	  ...
	  public function createMat(mat:BitmapData) : TextureMaterial
      {
		 var dss1:BitmapTextureResource = new BitmapTextureResource(mat);
		 dss1.upload(Game.context);
         var dss:TextureMaterial = new TextureMaterial(dss1);
		 dss.alphaThreshold = 1;
         return dss;
      }
      ...
      public function createChargeEffect(clientObject:ClientObject, user:ClientObject, localMuzzlePosition:Vector3, turret:Object3D, chargingTime:int) : IGraphicEffect
      {
         ...
         effect.init(user,310,310,this.chargeMaterials,localMuzzlePosition,turret,0,1000 * this.chargeMaterials.length / chargingTime);
         return effect;
      }
      ...
      private function createChargeMaterials(chargingPart1:String, chargingPart2:String, chargingPart3:String) : void
      {
         ...
         if(part3 != null)
         {
            ...
            this.chargeMaterials = charingData.material;
            return;
         }
         throw new Error("NULL");
      }
      ...
      private function drawPart1(sourceBitmapData:BitmapData, destBitmapData:BitmapData, frame:int, frameSize:int, blendMode:String) : void
      {
         ...
         destBitmapData.draw(sourceBitmapData,this.matrix,null,blendMode,null,true);
      }
