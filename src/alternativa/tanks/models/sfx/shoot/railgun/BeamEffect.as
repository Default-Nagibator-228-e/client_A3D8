package alternativa.tanks.models.sfx.shoot.railgun
{
   ...
   public class BeamEffect extends PooledObject implements IGraphicEffect
   {
      ...
      public function init(param1:Vector3, param2:Vector3, param3:TextureMaterial, param4:Number, param5:Number, param6:Number, param7:Number, param8:int, param9:TextureMaterial) : void
      {
         ...
         this.trail = new ShotTrail(param4, _loc9_, param3, param7);
		 this.trail1 = new ShotTrail(param4,_loc9_,param9,param7);
         this.time = 0;
      }
