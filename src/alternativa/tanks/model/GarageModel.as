   ...
   public class GarageModel extends GarageModelBase implements IGarageModelBase, IObjectLoadListener, IGarage, IItemListener, IDumper, IMoneyListener, IItemEffectListener
   {
      ...
      public static function replaceItemParams(oldId:String, newId:String) : void
      {
		 try{
			...
			alert.text = "Прызышла ашыбка: garagemodel,replaceItemParams,201";
			if (itemsParams == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: garagemodel,replaceItemParams,201,itemsParams";
			}
			if (itemsParams[oldId] == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: garagemodel,replaceItemParams,201,oldId: " + oldId;
			}
		 }
		 try{
			...
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,replaceItemParams,207,newId: " + newId + " eerob: " + e.getStackTrace();
			return;
		 }
		 try{
			...
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,replaceItemParams,213";
		 }
      }
      ...
      public function crystalsChanged(value:int) : void
      {
		 ...
		 if (this.lockBuy == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.lockBuy";
		 }
		 if (this.lockMount == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.lockMount";
		 }
		 if (this.lockReplace == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.lockReplace";
		 }
		 if (this.lockSell == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.lockSell";
		 }
		 if (this.lockUpgrade == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.lockUpgrade";
		 }
		 if (this.garageWindow == null)
		 {
			return;
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.garageWindow";
		 }
		 if (this.garageWindow.selectedItemId == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.garageWindow.selectedItemId";
		 }
		 if (this.garageWindow.storeItemSelected == null)
		 {
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: garagemodel,crystalsChanged,366,this.garageWindow.storeItemSelected";
		 }
