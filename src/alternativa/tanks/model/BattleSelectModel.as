package alternativa.tanks.model
{
   ...
   import alternativa.osgid.service.alert.IAlertService;
   import alternativa.osgid.service.dump.IDumpService;
   import alternativa.osgid.service.dump.dumper.IDumper;
   import alternativa.osgid.service.loaderParams.ILoaderParamsService;
   import alternativa.osgid.service.locale.ILocaleService;
   import alternativa.osgid.service.log.ILogService;
   import alternativa.osgid.service.log.LogLevel;
   import alternativa.osgid.service.mainContainer.IMainContainerService;
   import alternativa.osgid.service.storage.IStorageService;
   ...
   public class BattleSelectModel extends BattleSelectModelBase implements IBattleSelectModelBase, IObjectLoadListener, IResourceLoadListener, IDumper
   {
      ...
      public function addBattle(clientObject:ClientObject, battle:BattleClient) : void
      {
		 try{
			...
			alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,370";
			if (this.battles == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,370,this.battles";
			}
			if (battle == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,370,battle";
			}
			if (battle.battleId == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,370,battle.battleId";
			}
			return;
		 }
		 try{
			...
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,376";
			if (this.battles == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,370,this.battles";
		 ...
		 if (battleList == null)
		 {
			 try{
				...
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,384";
			 }
			 battleList = new ViewBattleList();
		 }
		 try{
			...
			var alert:AlertBugWindow = new AlertBugWindow();
			alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,392";
			if (battle == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,392, battle";
			}
			if (this.maps == null)
			{
				return;
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,392, this.maps";
			}
			if (this.panelModel == null)
			{
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,392, this.panelModel";
			}
		 }
         if(this.battlesArray.length > this.maxBattlesNum)
         {
			try{
				...
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,400";
				if (this.battlesArray == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,400, this.battlesArray";
				}
				if (this.maxBattlesNum == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,400, this.maxBattlesNum";
				}
				if (this.battleList == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,addBattle,400, this.battleList";
				}
			}
         }
      }
      ...
      public function removeBattle(clientObject:ClientObject, battleId:String) : void
      {
			 try{
				...
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450";
				if (battleId == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450,battleId, errrrraror: " + e.getStackTrace();
					return;
				}
				if (this.battles[battleId] == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450, " + battleId;
				}
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450, errrrraror: " + e.getStackTrace();
				return;
			 }
			 try{
				...
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,456";
				if (this.battlesArray == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450, this.battlesArray";
				}
			 }
			 if(this.battleList.selectedBattleID == battleId)
			 {
				try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,464";
				}
			 }
			 try{
				...
				var alert:AlertBugWindow = new AlertBugWindow();
				alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,471";
				if (this.battleList == null)
				{
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,450, this.battleList";
				}
			 }
			 ...
			 if(this.battlesArray.length <= this.maxBattlesNum)
			 {
				 try{
					...
					var alert:AlertBugWindow = new AlertBugWindow();
					alert.text = "Прызышла ашыбка: battleselectmodel,removeBattle,480";
				 }
			 }
      }
