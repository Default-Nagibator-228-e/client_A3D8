package alternativa.tanks.engine3d
{
   ...
   public interface ITextureMaterialRegistry
   {
      ...
      function getMaterial(param1:MaterialType, param2:BitmapData, param3:Number, param4:Boolean = true) : VertexLightTextureMaterial;
      
      function clear() : void;
      
      function getDump() : String;
      
      function disposeMaterial(param1:VertexLightTextureMaterial) : void;
   }
}
