package alternativa.tanks.engine3d
{
   ...
   public class TextureMaterialRegistry implements ITextureMaterialRegistry
   {
      ...
      private const materials:Vector.<VertexLightTextureMaterial> = new Vector.<VertexLightTextureMaterial>();
      ...
      {
         var _loc3_:MaterialEntry = new MaterialEntry(param1,param2 as VertexLightTextureMaterial);
      ...
      {
         var material:VertexLightTextureMaterial = null;
      }
      ...
      public function getMaterial(materialType:MaterialType, param1:BitmapData, mipMapResolution:Number, param2:Boolean = true) : VertexLightTextureMaterial
      {
         if(param1 == null)
         {
      ...
      {
         var _loc4_:VertexLightTextureMaterial = null;
      ...
      private function createMaterial(param1:BitmapData, param2:Boolean) : VertexLightTextureMaterial
      {
         var _loc4_:VertexLightTextureMaterial = TextureMaterialFactory.createTextureMaterial(this.getTexture(param1,param2));
         this.materials.push(_loc4_);
         this.materialStat.createCount++;
         return _loc4_;
      }
      
      private function createMaterialEntry(param1:BitmapData, param2:VertexLightTextureMaterial) : MaterialEntry
      {
      ...
      public function addMaterial(param1:VertexLightTextureMaterial) : void
      {
      ...
      public function disposeMaterial(material:VertexLightTextureMaterial) : void
      {
         if(material == null)
         {
            return;
      ...
      private function removeMaterialEntry(param1:MaterialEntry) : void
      {
         ...
         var _loc2_:VertexLightTextureMaterial = param1.material;
      ...
      {
         var _loc2_:VertexLightTextureMaterial = null;
      ...
      private function _clearTexture(param1:VertexLightTextureMaterial) : void
      {
		 (param1.diffuseMap as BitmapTextureResource).dispose();
         (param1.diffuseMap as BitmapTextureResource).data = null;
      }
      
      protected function getEntry(param1:VertexLightTextureMaterial) : MaterialEntry
      {
