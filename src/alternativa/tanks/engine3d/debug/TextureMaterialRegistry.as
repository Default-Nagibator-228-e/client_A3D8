package alternativa.tanks.engine3d.debug
{
   ...
   public class TextureMaterialRegistry implements ITextureMaterialRegistry
   {
      ...
      public function getMaterial(materialType:MaterialType, texture:BitmapData, mipMapResolution:Number, disposeMainTexure:Boolean = false) : VertexLightTextureMaterial
      {
         switch(materialType)
         {
