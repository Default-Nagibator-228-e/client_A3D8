package alternativa.tanks.display.usertitle
{
   ...
   public class UserTitle
   {
      ...
      public function UserTitle(isLocal:Boolean)
      {
         ...
         super();
         this.material = new TextureMaterial(new BitmapTextureResource(new BitmapData(100, 100)));
		 this.material.alphaThreshold = 1;
         this.local = isLocal;
	  ...
	  private function upload() : void
      {
		 if (upl)
		 {
			for each(var r:Resource in this.sprite.getResources(true))
			{
				r.dispose();
			}
			upl = false;
		 }
         for each(var r1:Resource in this.sprite.getResources(true))
		 {
      ...
      public function update(pos:Vector3) : void
      {
         ...
         if(this.dirtyFlags != 0)
         {
            ...
            {
				if (this.weaponBar == null) setupComponents();
      ...
      private function setupTexture() : void
      {
         ...
         if(this.texture == null || this.texture.width != width || this.texture.height != height)
         {
            ...
            (this.material.diffuseMap as BitmapTextureResource).data = this.texture;
