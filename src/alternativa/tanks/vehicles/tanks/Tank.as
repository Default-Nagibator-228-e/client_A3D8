package alternativa.tanks.vehicles.tanks
{
   ...
   public class Tank extends Body3D
   {
      ...
      public function Tank(skin:TankSkin, mass:Number, maxSpeed:Number, maxTurnSpeed:Number, turretMaxTurnSpeed:Number, turretTurnAcceleration:Number, isLocal:Boolean, titleContainer:Scene3DContainer)
      {
         ...
         var dimensions:Vector3 = new Vector3(2 * mesh.boundBox.maxX,2 * mesh.boundBox.maxY,mesh.boundBox.maxZ);
      ...
      private function calculateSkinCenterOffset(param1:Vector3) : void
      {
         ...
         this.skinCenterOffset.x = -0.5 * (_loc2_.boundBox.minX + _loc2_.boundBox.maxX);
         this.skinCenterOffset.y = -0.5 * (_loc2_.boundBox.minY + _loc2_.boundBox.maxY);
      ...
      {
         return new Vector3(mesh.boundBox.maxX - mesh.boundBox.minX,mesh.boundBox.maxY - mesh.boundBox.minY,mesh.boundBox.maxZ - mesh.boundBox.minZ);
      }
