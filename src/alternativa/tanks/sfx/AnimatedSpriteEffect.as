package alternativa.tanks.sfx
{
   ...
   public class AnimatedSpriteEffect extends PooledObject implements IGraphicEffect
   {
      ...
      public function init(width:Number, height:Number, materials:Vector.<TextureMaterial>, position:Vector3, rotation:Number, offsetToCamera:Number, fps:Number, loop:Boolean, originX:Number = 0.5, originY:Number = 0.5,param12:int=500,param13:int=1000) : void
      {
		 p12 = param12;
		 p13 = param13;
